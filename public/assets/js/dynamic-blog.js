...
(function () {
    ...
    function resolveImageUrl(url) {
        ...
        if (typeof url === 'string') {
            if (url.includes('api.boostrava.com/assets/')) {
                return url.replace('api.boostrava.com/assets/', 'boostrava.com/assets/');
            }
            if (url.includes('127.0.0.1:8000/assets/')) {
                return url.replace('127.0.0.1:8000/assets/', 'boostrava.com/assets/');
            }
